...
- Separate dithering and opaque-image quantization operations; reproduce and explicitly report the upstream transparent-quantization failure, and antialiasing analysis.
